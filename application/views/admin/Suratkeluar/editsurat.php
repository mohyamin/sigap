    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="mt-0 mb-0">Edit Surat Keluar</h5>
      ...
      <div class="seaction">
        ...
        <div class="card">
          <div class="card-content">
            <p class="caption mb-0">Edit surat keluar</p>
          </div>
        </div>
        ...
        <div class="row mb-5">
          ...
          <!-- Form with placeholder -->
            ...
            <div id="placeholder" class="card card card-default scrollspy">
              <div class="card-content">
                <form action="<?= base_url('User/SuratKeluar/EditSuratKeluar/'); ?><?= $idskluar; ?>" method="POST" enctype="multipart/form-data">
                  <h4 class="card-title">Form Edit Surat Keluar</h4>
                  <div class="row">
                        ...
                        <select class="select2-icons browser-default" id="kode_surat" name="kode_surat">
                            <option selected>Pilih Kode Surat</option>
                             ...
                             <option value="<?= $k['id_klasifikasi']; ?> " ? <?php if($k['id_klasifikasi'] == $surat['m_klasifikasi_id']){echo 'selected';} ?> ><?= $k["kode_surat"]; ?> - <?= $k["klasifikasi"]; ?></option>
                            <?php endforeach; ?>
                        </select>
