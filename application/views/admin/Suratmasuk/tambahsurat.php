    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="mt-0 mb-0">Tambah Surat Masuk</h5>
      ...
      <div class="seaction">
        ...
        <div class="card">
          <div class="card-content">
            <p class="caption mb-0">Tambah surat masuk baru dengan melengkapi field-field yang tersedia</p>
          </div>
        </div>
        ...
        <div class="row mb-5">
          ...
          <!-- Form with placeholder -->
            ...
            <div id="placeholder" class="card card card-default scrollspy">
              <div class="card-content">
                <?php echo form_open_multipart('Admin/SuratMasuk/create');?>
                  <h4 class="card-title">Form Tambah Surat Masuk</h4>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col s6 input-field">
                            <input id="index_surat" name="index_surat" type="text">
                            <label for="index_surat">Index Surat</label>
                            <?= form_error('index_surat', '<small class="red-text">', '</small>'); ?>
                    </div>
                  </div>

                 <div class="row">
                            <div class="col s6 input-field">
                        <select class="select2-icons browser-default" id="asal" name="asal">
                  ...
                  <div class="col s6 input-field">
                            <input id="tgl_terima" name="tgl_terima" type="date">
                 ...
                 <div class="row">
                        ...
                        <div class="col s6 input-field">
                            ...
                            <input type="file" name="file_masuk">
                    ...
                    <div class="row">
                      <div class="input-field col s6">
                          ...
                          <button class="btn cyan waves-effect waves-light green right" style="margin-right: 10px;" type="submit" name="action"> <i class="fas fa-save"></i> <a href="<?= base_url('Admin/SuratMasuk') ?>">Kembali</a> 
                          </button> 
